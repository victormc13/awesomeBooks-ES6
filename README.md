...
**[awesomeBooks-ES6]** It is a list library project where you can have a collection of your favorite books built with JavaScript.
...
```sh
  cd my-folder
  git clone https://github.com/victormc13/awesomeBooks-ES6.git
```
...
Feel free to check the [issues page](https://github.com/victormc13/awesomeBooks-ES6/issues).
